...
public class ServerInfo implements TerminalPrintablePojo {
    ...
    public String toTerminalString() {
        return new AttributedStringBuilder()
                .append("The server '").append(serverName, AttributedStyle.DEFAULT.foreground(AttributedStyle.GREEN))
                .append("' is running.").append("\n")
                .append("The default hostname is '").append(defaultHostname, AttributedStyle.DEFAULT.foreground(AttributedStyle.GREEN))
                .append("'.").append("\n").append("\n")
